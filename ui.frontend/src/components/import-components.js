...
const HandHeader = withAsyncImport(() => import('./HandHeader'));
const HandFooter = withAsyncImport(() => import('./HandFooter'));
const HandImage = withAsyncImport(() => import('./HandImage'));
const HandMainTitle = withAsyncImport(() => import('./HandMainTitle'));
const HandMainContent = withAsyncImport(() => import('./HandMainContent'));
const HandMainButton = withAsyncImport(() => import('./HandButton'));
...
//My components
MapTo("reactapp/components/hand-header")(HandHeader);
MapTo("reactapp/components/hand-footer")(HandFooter);
MapTo("reactapp/components/hand-image")(HandImage);
MapTo("reactapp/components/hand-main-title")(HandMainTitle);
MapTo("reactapp/components/hand-main-content")(HandMainContent);
MapTo("reactapp/components/hand-main-button")(HandMainButton);
